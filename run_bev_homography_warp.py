...
用法（在 0922code 目录下）:
  python run_bev_homography_warp.py
  python run_bev_homography_warp.py --method point --out_dir_point ../joint_gen/cam_label_point_proj
  python run_bev_homography_warp.py --method both --limit 10
"""
...
def _load_bev_homography_module():
    path = os.path.join(
        _ROOT, "multi_view_generation", "bev_utils", "bev_homography_warp.py"
    )
