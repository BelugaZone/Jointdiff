...
with torch.no_grad():
    ...
    log_file = open("/opt/data/private/hwj_autodrive/UniCon/eval_metric_visual/512_dat_result_metric/experiment_600sample_updown_cross_single512_15000.txt", "w")
    ...
    for step, batch in enumerate(test_dataloader):
        ...
        #         break 
            ...
            seed = (MASTER_SEED * 1000000 + processed_samples) % (2**32)
            ...
            # /opt/data/private/hwj_autodrive/UniCon/AAstanderd_imggen_joint/no_viewmask/imggen_dat_bce_85000 scale=4
           
            # /opt/data/private/hwj_autodrive/UniCon/AAstanderd_imggen_joint/pon_split/imggen_pure_25000_timeplan
            #/opt/data/private/hwj_autodrive/UniCon/AAstanderd_imggen_joint/pon_split/imggen_fullmodel_novhicle_25000
          

            output_dir_imgen= './AAstanderd_imggen_joint/pon_split/imggen_finalmodel_same_initnoise/img_gen'
            output_dir_bev_cond = './AAstanderd_imggen_joint/pon_split/imggen_finalmodel_same_initnoise/bev_cond'
            output_dir_gen_project = './AAstanderd_imggen_joint/pon_split/imggen_finalmodel_same_initnoise/gen_project'
            output_dir_imggt = './AAstanderd_imggen_joint/pon_split/imggen_finalmodel_same_initnoise/img_gt'
            output_dir_label = './AAstanderd_imggen_joint/pon_split/imggen_finalmodel_same_initnoise/label'
