...
用法（在 0922code 目录下）:
  python run_rgb_label_homography.py --input ../combined_811(1).png
  python run_rgb_label_homography.py --input ../joint_gen/label_rgb/foo.png --flip_bev_y
"""
...
def _load_bev_homography_module():
    path = os.path.join(_ROOT, "multi_view_generation", "bev_utils", "bev_homography_warp.py")
