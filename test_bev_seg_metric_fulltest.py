...
with torch.no_grad():
    ...
    log_file = open("/opt/data/private/hwj_autodrive/UniCon/eval_metric_visual/AAAponsplit/joint_img2bev/experiment_final_model_lss_25000.txt", "w")
    ...
    for step, batch in enumerate(test_dataloader):
        ...
        for i in range(batch["image"].shape[0]): 
            ...
            # # /opt/data/private/hwj_autodrive/UniCon/eval_metric_visual/AAAbev_cond_imgen_visualize/CVTsplit_85000_full
