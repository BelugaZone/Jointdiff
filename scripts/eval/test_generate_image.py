...
with torch.no_grad():
    ...
    for step, batch in enumerate(test_dataloader):
        ...
        for i in range(batch["image"].shape[0]): 
            ...
            # /opt/data/private/hwj_autodrive/jointdiff/AAstanderd_imggen/ponsplit/imggen_full_85000
            # /opt/data/private/hwj_autodrive/jointdiff/AAstanderd_imggen/ponsplit/imggen_full_timeplan_bev2img_85000
            # /pon_split/imggen_full_doubleloss_45000
            # /opt/data/private/hwj_autodrive/jointdiff/AAstanderd_imggen/448/imggen_finalmodel_448_25000
