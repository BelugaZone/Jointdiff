...
with torch.no_grad():
    ...
    log_file = open("/opt/data/private/hwj_autodrive/jointdiff/eval_metric_visual/AAAponsplit/joint_img2bev/experiment_final_model_lss_25000.txt", "w")
    ...
    for step, batch in enumerate(test_dataloader):
        ...
        for i in range(batch["image"].shape[0]): 
            ...
            # # /opt/data/private/hwj_autodrive/jointdiff/eval_metric_visual/AAAbev_cond_imgen_visualize/CVTsplit_85000_full

            # output_dir_masked_pred = './eval_metric_visual/AAAbev_cond_imgen_visualize/PONsplit_timeplan_img2bev_10000/pred'
            # output_dir_masked_bev = './eval_metric_visual/AAAbev_cond_imgen_visualize/PONsplit_timeplan_img2bev_10000/gt'
