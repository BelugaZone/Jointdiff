...
with torch.no_grad():
    ...
    log_file = open("/opt/data/private/hwj_autodrive/jointdiff/eval_metric_visual/AAAponsplit/test.txt", "w")
    ...
    for step, batch in enumerate(test_dataloader):
        ...
        for i in range(batch["image"].shape[0]): 
            ...
            # /opt/data/private/hwj_autodrive/jointdiff/eval_metric_visual/AAAbev_cond_imgen_visualize/finnal_mdoel_small_visual

            output_dir_masked_pred = '/opt/data/private/hwj_autodrive/jointdiff/eval_metric_visual/AAAbev_cond_imgen_visualize/finnal_model_small_visual_extime/pred'
            output_dir_masked_bev = '/opt/data/private/hwj_autodrive/jointdiff/eval_metric_visual/AAAbev_cond_imgen_visualize/finnal_model_small_visual_extime/bev_gt'
            output_dir_img = '/opt/data/private/hwj_autodrive/jointdiff/eval_metric_visual/AAAbev_cond_imgen_visualize/finnal_model_small_visual_extime/img_gt'
            output_dir_label = '/opt/data/private/hwj_autodrive/jointdiff/eval_metric_visual/AAAbev_cond_imgen_visualize/finnal_model_small_visual_extime/label'
            output_dir_project = '/opt/data/private/hwj_autodrive/jointdiff/eval_metric_visual/AAAbev_cond_imgen_visualize/finnal_model_small_visual_extime/gen_project'
