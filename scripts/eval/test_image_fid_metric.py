...
from cleanfid import downloads_helper
...
def compute_fid():
    ...
    score = fid.compute_fid('/opt/data/private/hwj_autodrive/jointdiff/AAstanderd_imggen_joint/448/imggen_finalmode_448_25000/img_gt', '/opt/data/private/hwj_autodrive/jointdiff/AAstanderd_imggen_joint/448/imggen_finalmode_448_25000/img_gen')
...
def main(
    ...
    fid = fid.compute_fid(str(gt_dir.resolve()), str(comp_dir.resolve()))
    print(f'Results : {fid:.2f}')
    

if __name__ == "__main__":
    # print(downloads_helper.check_download_inception())
   
    score = compute_fid()
    print(f'Results : {score:.2f}')