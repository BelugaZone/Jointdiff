...
from utils.utils import blip2_cap, get_combined_filename, save_png_with_comment, set_jointdiff_config_inference, \
...
def load_jointdiff_weights(unet, checkpoint_path, post_joint, model_name=None,
...
if __name__ == '__main__':
    ...
    active_adapters = load_jointdiff_weights(unet, checkpoint_path, post_joint, model_name=model_name)

   

    unet.set_adapters(active_adapters)
    patch.hack_lora_forward(unet)
    print("load_jointdiff_weights over")
    ...
    def unconditional_generation_pndm(
        ...
        set_jointdiff_config_inference(unet, inputs_config["pairs"], batch_size=inputs_config["num_input"],
        ...
        save_dir = "/opt/data/private/hwj_autodrive/jointdiff/new_inference_results"
