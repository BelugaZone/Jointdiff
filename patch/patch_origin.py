    ...
    class UniConBlock(block_class):
        ...
        def forward(
            ...
            if self.enable_joint_attention:
                ...
                # print('attn_output1n_x',attn_output1n_x.dtype)
                # print('output1n',output1n.dtype)
                attn_output1n_x = attn_output1n_x.to(output1n.dtype)
                attn_output1n_y = attn_output1n_y.to(output1n.dtype)
