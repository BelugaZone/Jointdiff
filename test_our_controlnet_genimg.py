...
CONTROLNET_PATH = "/opt/data/private/hwj_autodrive/UniCon/controlnet_training_results_3c/checkpoints/epoch_41"    # 训练好的ControlNet路径
OUTPUT_DIR = "/opt/data/private/hwj_autodrive/UniCon/controlnet_training_results_3c/checkpoints/epoch_41"  # 输出目录
