...
class seg_decorder(nn.Module):
    ...
    def __init__(self,
        ...
        self.seg_head_img = SegEncode(64, 6, self.out_size)
    ...
    def forward(self, diffusion_features,camera_intrinsic):
        ...
        input_x_lss_4d = self.lssformer(img_features,camera_intrinsic) #（b, cxd, H, W）
        # print('input_x_lss_4d',input_x_lss_4d.shape)

        img2bev_out = self.seg_head_img(input_x_lss_4d)
