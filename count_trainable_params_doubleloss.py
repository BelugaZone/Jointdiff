"""
在「与 train_unicon_new_full_withcamparam_doubleloss_imgae2bev.py 相同依赖」的环境下运行，
打印 UNet、seg_head 及合计的 requires_grad=True 参数量。

用法（在 0922code 目录下）:
  python count_trainable_params_doubleloss.py --pretrained_model_name_or_path runwayml/stable-diffusion-v1-5
"""
