...
with torch.no_grad():
    ...
    for step, batch in enumerate(test_dataloader):
        ...
        for i in range(batch["image"].shape[0]): 
            ...
            # masked_pred = viz_bev(masked_pred).pil/opt/data/private/hwj_autodrive/UniCon/AAstanderd_imggen/448/imggen_full_45000

            # /opt/data/private/hwj_autodrive/UniCon/AAstanderd_imggen/448/imggen_finalmodel_448_25000
      
            output_dir_imgen= './AAstanderd_imggen/448/imggen_finalmodel_448_25000_scle=5/img_gen'
            output_dir_bev_cond = './AAstanderd_imggen/448/imggen_finalmodel_448_25000_scle=5/bev_cond'
            output_dir_gen_project = './AAstanderd_imggen/448/imggen_finalmodel_448_25000_scle=5/gen_project'
            output_dir_imggt = './AAstanderd_imggen/448/imggen_finalmodel_448_25000_scle=5/img_gt'
            output_dir_label = './AAstanderd_imggen/448/imggen_finalmodel_448_25000_scle=5/label'
